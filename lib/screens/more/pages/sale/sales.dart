                ...
                child: Column(
                  children: [
                    ...
                    Obx(
                      () => CustomAnimatedContainer(
                        text:
                            _salesController.state.value.chosenDuration != null
                        ...
                        onTap: () async {
                          await Picker.custom(
                              context: context,
                              values: _salesController.state.value.durations,
                              currentValue:
                                  _salesController.state.value.chosenDuration,
                    ...
                    Obx(() => AnimatedContainer(
                        ...
                        height:
                            _salesController.state.value.isPersonal ? 12 : 0)),
                    _animatedVisible(
                      context,
                      child: Row(
                        children: [
                    ...
                    Obx(
                      () => CustomAnimatedContainer(
                        text: (_salesController.state.value.currentService !=
                                null)
                            ? _salesController.state.value.currentService!.name
                        ...
                        onTap: () {
                          if (_salesController.state.value.clients.isNotEmpty) {
                            if (_salesController.state.value.chosenDuration !=
                              ...
                              Get.toNamed(Routes.sale_services);
                            } else {
                              _getSnackbar;
                            }
                          } else {
                    ...
                    Obx(
                      () => CustomAnimatedContainer(
                        text: _salesController.state.value.quantity != null
                            ? _salesController.state.value.quantity!.toString()
                        ...
                        if (!_salesController.state.value.isPersonal) {
                          return Column(
                              children: List.generate(
                                  _salesController.state.value.clients.length,
                                  (index) {
                      ...
                      if (_salesController.state.value.currentService != null) {
                        if (_salesController.state.value.quantity != null) {
                          return Padding(
                            ...
                            child: Text(
                              '${S.of(context).amount}: ${_salesController.state.value.currentService!.price * _salesController.state.value.quantity!} ₽',
